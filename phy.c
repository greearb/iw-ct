			   ...
			   int argc, char **argv)
{
	...
	static const struct {
		...
		{ .name = "NO_HT5", .val = NL80211_CHAN_NO_HT5, },
		{ .name = "HT5", .val = NL80211_CHAN_HT5, },
		{ .name = "NO_HT10", .val = NL80211_CHAN_NO_HT10, },
		{ .name = "HT10", .val = NL80211_CHAN_HT10, },
...
COMMAND(set, freq, "<freq> [NO_HT5|HT5|NO_HT10|HT10|HT20|HT40+|HT40-]",
